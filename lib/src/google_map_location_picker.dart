...
class LocationPickerState extends State<LocationPicker> {
  ...
  void decodeAndSelectPlace(String placeId) {
    ...
    final endpoint =
        "https://maps.googleapis.com/maps/api/place/details/jsonkey=${widget.apiKey}" +
            "&placeid=$placeId" +
            '&language=${widget.language}';
...
//  }
  ...
  Future reverseGeocodeLatLng(LatLng latLng) async {
    final endpoint =
        "https://maps.googleapis.com/maps/api/geocode/jsonlatlng=${latLng.latitude},${latLng.longitude}" +
            "&key=${widget.apiKey}" +
            "&language=${widget.language}";
